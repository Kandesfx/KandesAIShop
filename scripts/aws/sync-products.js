...
const PRODUCTS_TO_SYNC = [
  {
    ...
    salePriceCents: 3500000n, // 35.000 đ
    ...
    variants: [
      ...
      },
      {
        ...
        sku: 'CRS-PRO-3D-400R',
        priceCents: 11000000n,
        salePriceCents: 7000000n,
        durationDays: 3,
        position: 2,
      ...
      },
      {
        ...
        sku: 'CRS-PRO-7D-400R',
        priceCents: 16000000n,
        salePriceCents: 10000000n,
        durationDays: 7,
        position: 3,
      ...
      },
      {
        ...
        priceCents: 45000000n,
        salePriceCents: 27000000n,
        durationDays: 30,
        position: 5,
  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        ...
        priceCents: 130000000n,
        salePriceCents: 65000000n,
        durationDays: 30,
        position: 3,
...
async function main() {
  ...
  for (const prodData of PRODUCTS_TO_SYNC) {
    const { variants, ...fields } = prodData;
