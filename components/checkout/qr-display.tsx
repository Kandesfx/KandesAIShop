  ...
  return (
    <>
      ...
      >
          ...
          <div className="flex flex-col items-center gap-2">
              ...
              {!imgLoaded && !imgError && (
                <div className="w-[190px] h-[190px] rounded-lg bg-ink-950 flex flex-col items-center justify-center text-center p-3 space-y-2.5">
                  ...
                  <div className="space-y-1">
                    <p className="text-[11px] font-mono text-electric font-bold animate-pulse">
                      Đang tạo VietQR...
                    </p>
                ...
                <>
                  ...
                  {imgLoaded && (
                    <div className="absolute inset-0 bg-ink-950/60 backdrop-blur-[2px] rounded-xl opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-1.5 text-ink-50">
                      ...
                      <span className="text-[10px] font-mono font-bold text-electric uppercase tracking-wider bg-ink-900/90 px-2 py-0.5 rounded border border-electric/40">
                        Bấm để phóng to
                      </span>
                    </div>
                  )}
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="text-[10px] font-mono text-ink-300 hover:text-electric flex items-center gap-1 transition-colors py-1 px-2.5 rounded bg-ink-800 border border-ink-700 hover:border-electric/40 disabled:opacity-50 disabled:pointer-events-none"
              >
              ...
              <button
                ...
                className="text-[10px] font-mono text-ink-300 hover:text-electric flex items-center gap-1 transition-colors py-1 px-2.5 rounded bg-ink-800 border border-ink-700 hover:border-electric/40"
              >
          ...
          <div className="space-y-2.5 min-w-0">
            ...
            <div className="p-2.5 bg-ink-800/90 border border-ink-700/90 rounded-xl flex items-center justify-between gap-2">
              ...
              <Button
                ...
                size="sm"
                className={cn(
                  'h-7 px-2 text-[11px] font-mono transition-all flex-shrink-0 border-ink-600 hover:border-electric/50',
        ...
        <div className="p-2.5 bg-ink-950/95 border border-ink-800 rounded-lg flex items-center justify-between text-[11px] text-ink-200">
          <div className="flex items-center gap-2">
        ...
        >
          ...
          >
            ...
            <div className="space-y-1 pt-1">
              <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-electric block">
