...
| Phase 9: Storefront Polish & UX Enhancement | ⏳ **TODO** (2026-08-09) | 15 features chia 4 đợt (7-10 ngày). **Đợt 1 (PDP Polish)**: D10 average rating + D1 reviews/Q&A tabs + D2 cross-sell carousel + D4 share buttons + D5 trust signals. **Đợt 2 (Checkout Hardening)**: C7 Turnstile CAPTCHA + D7 checkout timeline + C5/F4 success page route + F3 poller optimization. **Đợt 3 (Cart & Mobile UX)**: D3 save-for-later/wishlist + D8 cart icon bounce + D6 mobile gallery scroll. **Đợt 4 (Technical)**: C6 countdown sync tabs + D9 footer dynamic version + cleanup. Backlog từ Phase 8b (12 items D1-D10, C5-C7, F3-F4). 3 migrations (Product rating + ProductQuestion + Wishlist), 10 new API routes, 15 new components. Target: conversion +15%, cart abandonment -10%, fraud -20%. Spec: `docs/tasks/PHASE_9_POLISH.md`. Plan: `docs/tasks/PHASE_9_PLAN.md`. |
